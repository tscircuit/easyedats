...
export class EasyEdaHole extends EasyEdaShape {
  static readonly token = "HOLE"

  constructor(init: EasyEdaShapeInit = {}) {
    super(
      init.source === undefined ? { ...init, token: EasyEdaHole.token } : init,
    )
  }
...
EasyEdaShape.register(EasyEdaHole)
